...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/popular-repositories', [IssueController::class, 'popularRepositories']);
    Route::get('/popular-repositories-with-issues', [IssueController::class, 'popularRepositoriesWithIssues']);
